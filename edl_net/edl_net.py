...
class EDLNet_MNIST(nn.Module):
    def __init__(self, num_classes=10, dropout=False):
        super(EDLNet_MNIST, self).__init__()
        ...
        # Define layers
        self.conv1 = nn.Conv2d(1, self.conv1_out_channels, kernel_size=3, padding=1)
        ...
        self.fc1 = nn.Linear(784, self.fc1_out_features)
...
class EDLNet_CIFAR10(nn.Module):
    def __init__(self, num_classes=10, dropout=False):
        super(EDLNet_CIFAR10, self).__init__()
        self.aapl = nn.AdaptiveAvgPool2d((32, 32))  # adaptive layer for variable input sizes
        self.use_dropout = dropout
